...
* @param[in] u32SysClock. The system clock speed.
* @param[in] u8UARTPort . Valid values as Fsys clock:
*                       - \ref UART0_Timer1
*                       - \ref UART0_Timer3
*                       - \ref UART1
* @param[in] u32Baudrate. UART baud rate setting
*                       - \ref 115200 
* @note      None.
* @exmaple : UART_Open(24000000, UART0_Timer1, 115200);
*/
