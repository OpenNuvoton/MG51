...
;------------------------------------------------------------
	Smain$main$0 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:14: void main (void) 
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	Smain$main$1 ==.
	Smain$main$2 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:18: MODIFY_HIRC(HIRC_24);
	mov	dpl,#0x06
	lcall	_MODIFY_HIRC
	Smain$main$3 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:19: Enable_UART0_VCOM_printf_24M_115200();
	lcall	_Enable_UART0_VCOM_printf_24M_115200
	Smain$main$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:20: printf ("\n\r This code must run in LDROM !!");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$5 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:21: printf ("\n\r Enable LDROM in CONFIG and <BOOT FROM LDROM> !");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$6 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:22: printf ("\n\r ");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$7 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:23: printf ("\n\r Toggle P05 to low to start test ...");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$8 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:25: GPIO_LED_QUASI_MODE;
	anl	_P0M1,#0xdf
	anl	_P0M2,#0xdf
	Smain$main$9 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:26: while (GPIO_LED);
00101$:
	jb	_P05,00101$
	Smain$main$10 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:28: for(i=0;i<128;i++)
	mov	r7,#0x00
00108$:
	Smain$main$11 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:29: IAPDataBuf[i]=i;
	mov	a,r7
	add	a,#_IAPDataBuf
	mov	dpl,a
	clr	a
...
00134$:
	jc	00108$
	Smain$main$13 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:31: Erase_APROM(0x80,128);
	...
	lcall	_Erase_APROM
	Smain$main$14 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:32: Erase_Verify_APROM(0x80,128);
	...
	Smain$main$15 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:33: Program_APROM(0x80,128);
	...
	Smain$main$16 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:34: Program_Verify_APROM(0x80,128);
	...
	Smain$main$17 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:36: while(1);
00106$:
	sjmp	00106$
	Smain$main$18 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c:37: }
	Smain$main$19 ==.
	XG$main$0$0 ==.
	ret
	Smain$main$20 ==.
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_LD_Program_AP/main.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
