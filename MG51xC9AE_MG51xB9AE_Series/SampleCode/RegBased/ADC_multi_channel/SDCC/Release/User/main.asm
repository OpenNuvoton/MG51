...
;------------------------------------------------------------
	Smain$main$0 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:10: void main (void) 
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	Smain$main$1 ==.
	Smain$main$2 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:15: MODIFY_HIRC(HIRC_24);
	mov	dpl,#0x06
	lcall	_MODIFY_HIRC
	Smain$main$3 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:16: Enable_UART0_VCOM_printf_24M_115200();
	lcall	_Enable_UART0_VCOM_printf_24M_115200
	Smain$main$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:17: printf ("\n Test start ...");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$5 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:20: ENABLE_ADC_BANDGAP;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	orl	_ADCCON1,#0x01
	Smain$main$6 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:21: ADCCON1|=0X30;            /* clock divider */
	orl	_ADCCON1,#0x30
	Smain$main$7 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:22: ADCCON2|=0X0E;            /* AQT time */
	orl	_ADCCON2,#0x0e
	Smain$main$8 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:23: clr_ADCCON0_ADCF;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	clr	_ADCF
	Smain$main$9 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:24: set_ADCCON0_ADCS;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	setb	_ADCS
	Smain$main$10 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:25: while(!(ADCCON0&SET_BIT7));;
00101$:
	mov	a,_ADCCON0
	jnb	acc.7,00101$
	Smain$main$11 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:26: ADCdataVBG = ADCRH<<4;
	mov	r6,_ADCRH
	clr	a
	swap	a
	anl	a,#0xf0
	...
	mov	r7,a
	Smain$main$12 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:27: ADCdataVBG |= ADCRL&0x0F;
	mov	r4,_ADCRL
	anl	ar4,#0x0f
	mov	r5,#0x00
	mov	a,r6
	...
	orl	ar5,a
	Smain$main$13 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:28: DISABLE_ADC;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	anl	_ADCCON1,#0xfe
	Smain$main$14 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:29: printf("\n ADC channel bandgap =0x%x", ADCdataVBG);
	push	ar4
	push	ar5
	mov	a,#___str_1
	push	acc
	...
	mov	sp,a
	Smain$main$15 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:30: Timer0_Delay(24000000,200,1000);
	...
	lcall	_Timer0_Delay
	Smain$main$16 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:33: ENABLE_ADC_AIN5;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	orl	_ADCCON1,#0x01
	Smain$main$17 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:34: ADCCON1|=0X30;            /* clock divider */
	orl	_ADCCON1,#0x30
	Smain$main$18 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:35: ADCCON2|=0X0E;            /* AQT time */
	orl	_ADCCON2,#0x0e
	Smain$main$19 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:36: clr_ADCCON0_ADCF;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	clr	_ADCF
	Smain$main$20 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:37: set_ADCCON0_ADCS;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	setb	_ADCS
	Smain$main$21 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:38: while(!(ADCCON0&SET_BIT7)); /* wait ADCF */
00104$:
	mov	a,_ADCCON0
	jnb	acc.7,00104$
	Smain$main$22 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:39: ADCdataAIN5 = ADCRH<<4;
	mov	r6,_ADCRH
	clr	a
	swap	a
	anl	a,#0xf0
	...
	mov	r7,a
	Smain$main$23 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:40: ADCdataAIN5 |= ADCRL&0x0F;
	mov	r4,_ADCRL
	anl	ar4,#0x0f
	mov	r5,#0x00
	mov	a,r6
	...
	orl	ar5,a
	Smain$main$24 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:41: DISABLE_ADC;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	anl	_ADCCON1,#0xfe
	Smain$main$25 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:42: printf("\n ADC channel 5 =0x%x", ADCdataAIN5);
	push	ar4
	push	ar5
	mov	a,#___str_2
	push	acc
	...
	mov	sp,a
	Smain$main$26 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:43: Timer0_Delay(24000000,200,1000);
	mov	dptr,#_Timer0_Delay_PARM_2
	mov	a,#0xc8
	movx	@dptr,a
	clr	a
	...
	lcall	_Timer0_Delay
	Smain$main$27 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:45: while(1);
00108$:
	sjmp	00108$
	Smain$main$28 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c:46: }
	Smain$main$29 ==.
	XG$main$0$0 ==.
	ret
	Smain$main$30 ==.
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_multi_channel/main.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
