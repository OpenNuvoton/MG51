...
;------------------------------------------------------------
	Smain$SPI_Error$0 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:12: void SPI_Error(void)
;	-----------------------------------------
;	 function SPI_Error
;	-----------------------------------------
_SPI_Error:
	...
	Smain$SPI_Error$1 ==.
	Smain$SPI_Error$2 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:14: printf ("\n SPI transfer error! ");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	Smain$SPI_Error$3 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:15: while(1);                                       // SPI error
00102$:
	sjmp	00102$
	Smain$SPI_Error$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:16: }
	Smain$SPI_Error$5 ==.
	XG$SPI_Error$0$0 ==.
	ret
	Smain$SPI_Error$6 ==.
...
;------------------------------------------------------------
	Smain$SPI_Initial$7 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:19: void SPI_Initial(void)
;	-----------------------------------------
...
_SPI_Initial:
	Smain$SPI_Initial$8 ==.
	Smain$SPI_Initial$9 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:21: P15_QUASI_MODE;                                  // P15 (SS) Quasi mode
	anl	_P1M1,#0xdf
	anl	_P1M2,#0xdf
	Smain$SPI_Initial$10 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:22: P10_QUASI_MODE;                                  // P10 (SPCLK) Quasi mode
	anl	_P1M1,#0xfe
	anl	_P1M2,#0xfe
	Smain$SPI_Initial$11 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:23: P00_QUASI_MODE;                                  // P00 (MOSI) Quasi mode
	anl	_P0M1,#0xfe
	anl	_P0M2,#0xfe
	Smain$SPI_Initial$12 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:24: P01_QUASI_MODE;                                  // P01 (MISO) Quasi mode
	anl	_P0M1,#0xfd
	anl	_P0M2,#0xfd
	Smain$SPI_Initial$13 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:26: set_SPSR_DISMODF;                                // SS General purpose I/O ( No Mode Fault ) 
	orl	_SPSR,#0x08
	Smain$SPI_Initial$14 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:27: clr_SPCR_SSOE;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:29: clr_SPCR_LSBFE;                                  // MSB first
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:31: clr_SPCR_CPOL;                                   // The SPI clock is low in idle mode
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:32: clr_SPCR_CPHA;                                   // The data is sample on the second edge of SPI clock 
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:34: set_SPCR_MSTR;                                   // SPI in Master mode 
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:35: SPICLK_FSYS_DIV16;                                    // Select SPI clock 
	anl	_SPCR,#0xfc
	orl	_SPCR,#0x03
	Smain$SPI_Initial$20 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:36: set_SPCR_SPIEN;                                  // Enable SPI function 
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:37: clr_SPSR_SPIF;
	anl	_SPSR,#0x7f
	Smain$SPI_Initial$22 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:38: }
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:40: void Start_SPI_process(uint8_t *pu8MID, uint8_t *pu8DID)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:42: SS = 0;
;	assignBit
	clr	_P15
	Smain$Start_SPI_process$28 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:44: Spi_Write_Byte(0x90);
	mov	dpl,#0x90
	lcall	_Spi_Write_Byte
	Smain$Start_SPI_process$29 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:45: if(SPDR != 0x4E)
	mov	a,#0x4e
	cjne	a,_SPDR,00133$
	sjmp	00102$
00133$:
	Smain$Start_SPI_process$30 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:46: SPI_Error(); 
	lcall	_SPI_Error
00102$:
	Smain$Start_SPI_process$31 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:49: _delay_();                              /* remark #define slave interrupt for normal polling transmittion */
	lcall	__delay_
	Smain$Start_SPI_process$32 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:52: Spi_Write_Byte(0x01);
	mov	dpl,#0x01
	lcall	_Spi_Write_Byte
	Smain$Start_SPI_process$33 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:53: if(SPDR != 0x55)
	mov	a,#0x55
	cjne	a,_SPDR,00134$
	sjmp	00104$
00134$:
	Smain$Start_SPI_process$34 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:54: SPI_Error();
	lcall	_SPI_Error
00104$:
	Smain$Start_SPI_process$35 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:57: _delay_();
	lcall	__delay_
	Smain$Start_SPI_process$36 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:60: Spi_Write_Byte(0x02);
	mov	dpl,#0x02
	lcall	_Spi_Write_Byte
	Smain$Start_SPI_process$37 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:61: if(SPDR != 0x56)
	mov	a,#0x56
	cjne	a,_SPDR,00135$
	sjmp	00106$
00135$:
	Smain$Start_SPI_process$38 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:62: SPI_Error();
	lcall	_SPI_Error
00106$:
	Smain$Start_SPI_process$39 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:65: _delay_();
	lcall	__delay_
	Smain$Start_SPI_process$40 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:68: Spi_Write_Byte(0x03);
	mov	dpl,#0x03
	lcall	_Spi_Write_Byte
	Smain$Start_SPI_process$41 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:69: if(SPDR != 0x4F)
	mov	a,#0x4f
	cjne	a,_SPDR,00136$
	sjmp	00108$
00136$:
	Smain$Start_SPI_process$42 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:70: SPI_Error();
	lcall	_SPI_Error
00108$:
	Smain$Start_SPI_process$43 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:73: _delay_();
	lcall	__delay_
	Smain$Start_SPI_process$44 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:76: Spi_Write_Byte(0x04);
	mov	dpl,#0x04
	lcall	_Spi_Write_Byte
	Smain$Start_SPI_process$45 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:77: if(SPDR != 0x54)
	mov	a,#0x54
	cjne	a,_SPDR,00137$
	sjmp	00110$
00137$:
	Smain$Start_SPI_process$46 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:78: SPI_Error();
	lcall	_SPI_Error
00110$:
	Smain$Start_SPI_process$47 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:81: _delay_();
	lcall	__delay_
	Smain$Start_SPI_process$48 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:85: *pu8MID = Spi_Read_Byte(0xFF);                             // Receive Slave 1st DATA from Slave
	mov	dptr,#_Start_SPI_process_pu8MID_65536_157
	movx	a,@dptr
	mov	r5,a
	inc	dptr
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:86: *pu8DID = Spi_Read_Byte(0xFF);                             // Receive Slave 2nd DATA from Slave
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:88: SS = 1;    
;	assignBit
	setb	_P15
	Smain$Start_SPI_process$51 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:89: }
...
;------------------------------------------------------------
	Smain$main$54 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:96: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	Smain$main$55 ==.
	Smain$main$56 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:100: MODIFY_HIRC(HIRC_24);
	mov	dpl,#0x06
	lcall	_MODIFY_HIRC
	Smain$main$57 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:101: Enable_UART0_VCOM_printf_24M_115200();
	lcall	_Enable_UART0_VCOM_printf_24M_115200
	Smain$main$58 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:103: SPI_Initial();
	lcall	_SPI_Initial
	Smain$main$59 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:104: Start_SPI_process(&u8MID,&u8DID);
	mov	dptr,#_Start_SPI_process_PARM_2
	...
	Smain$main$60 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:106: if((u8MID != 0x4F)&&(u8DID != 0x4E))
	mov	dptr,#_main_u8MID_65536_160
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x4f,00121$
...
00122$:
	Smain$main$61 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:107: SPI_Error();
	lcall	_SPI_Error
00102$:
	Smain$main$62 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:109: printf ("\n SPI transfer done! ");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$63 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:110: while(1);                                    // SPI transmission finish and P0.6 flash
00105$:
	sjmp	00105$
	Smain$main$64 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c:111: }
	Smain$main$65 ==.
	XG$main$0$0 ==.
	ret
	Smain$main$66 ==.
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/SPI_Master/main.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
