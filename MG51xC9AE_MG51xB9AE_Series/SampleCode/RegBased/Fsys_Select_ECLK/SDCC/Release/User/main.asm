...
;------------------------------------------------------------
	Smain$main$0 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:10: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	Smain$main$1 ==.
	Smain$main$2 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:18: P11_QUASI_MODE;
	anl	_P1M1,#0xfd
	anl	_P1M2,#0xfd
	Smain$main$3 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:19: set_CKCON_CLOEN;                                  // Also can check P1.1 CLO pin for clock to find the Fsys change.
	orl	_CKCON,#0x02
	Smain$main$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:20: while (P17);
00101$:
	jb	_P17,00101$
	Smain$main$5 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:21: FsysSelect(FSYS_OSCIN_P30);
	mov	dpl,#0x04
	lcall	_FsysSelect
	Smain$main$6 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:22: Timer0_Delay(16000000,200,1000);
	...
	lcall	_Timer0_Delay
	Smain$main$7 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:23: while (!P17);
00104$:
	jnb	_P17,00104$
	Smain$main$8 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:24: FsysSelect(FSYS_HIRC);
	mov	dpl,#0x02
	lcall	_FsysSelect
	Smain$main$9 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:25: Timer0_Delay(16000000,2000,1000);
	mov	dptr,#_Timer0_Delay_PARM_2
	mov	a,#0xd0
	movx	@dptr,a
	mov	a,#0x07
	...
	lcall	_Timer0_Delay
	Smain$main$10 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:27: while(1);
00108$:
	sjmp	00108$
	Smain$main$11 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c:29: }
	Smain$main$12 ==.
	XG$main$0$0 ==.
	ret
	Smain$main$13 ==.
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/Fsys_Select_ECLK/main.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
