...
C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/i2c.c \
...
Library/i2c.rel: C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/i2c.c Library/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: SDCC Compiler'
	sdcc -c --debug --out-fmt-elf -D__SDCC__ -I"C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/I2C_EEPROM_Master_Interrupt/SDCC/../../../../Library/Device/Include" -I"C:/Program Files (x86)/Nuvoton Tools/OpenOCD/bin/../../Toolchain/SDCC/include" -I"C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/I2C_EEPROM_Master_Interrupt/SDCC/../../../../Library/StdDriver/inc" --model-large -o"$@" "$<" && \
	echo -n $(@:%.rel=%.d) $(dir $@) > $(@:%.rel=%.d) && \
