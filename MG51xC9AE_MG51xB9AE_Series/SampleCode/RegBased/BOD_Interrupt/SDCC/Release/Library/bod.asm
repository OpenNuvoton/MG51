...
;------------------------------------------------------------
	Sbod$BOD_Open$0 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:30: void BOD_Open(uint8_t u8bodstatus, uint8_t u8bodlevel, uint8_t u8bodresetstatus)
;	-----------------------------------------
;	 function BOD_Open
;	-----------------------------------------
_BOD_Open:
	...
	movx	@dptr,a
	Sbod$BOD_Open$2 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:32: SFRS=0;
	mov	_SFRS,#0x00
	Sbod$BOD_Open$3 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:33: BODCON0=0;
	mov	_BODCON0,#0x00
	Sbod$BOD_Open$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:34: TA_REG_TMP |= (u8bodlevel | u8bodresetstatus);          // BOD level select and reset status
	...
	orl	_TA_REG_TMP,a
	Sbod$BOD_Open$5 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:35: TA_REG_TMP |= (u8bodstatus<<7) & SET_BIT7;
	mov	dptr,#_BOD_Open_u8bodstatus_65536_153
	movx	a,@dptr
	rr	a
	anl	a,#(0x80&0x80)
	orl	_TA_REG_TMP,a
	Sbod$BOD_Open$6 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:36: TA=0xAA; TA=0x55; BODCON0=TA_REG_TMP;
	mov	_TA,#0xaa
	mov	_TA,#0x55
	mov	_BODCON0,_TA_REG_TMP
	Sbod$BOD_Open$7 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:37: }
	Sbod$BOD_Open$8 ==.
	XG$BOD_Open$0$0 ==.
	ret
	Sbod$BOD_Open$9 ==.
...
;------------------------------------------------------------
	Sbod$BOD_LowPower$10 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:51: void BOD_LowPower(uint8_t u8LPBDD)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:53: SFRS=0; BODCON1=0;
	mov	_SFRS,#0x00
	mov	_BODCON1,#0x00
	Sbod$BOD_LowPower$13 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:54: TA=0xAA;TA=0x55;BODCON1 |= u8LPBDD;
	mov	_TA,#0xaa
	mov	_TA,#0x55
	movx	a,@dptr
	orl	_BODCON1,a
	Sbod$BOD_LowPower$14 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:55: }
...
;------------------------------------------------------------
	Sbod$BOD_Interrupt_Enable$17 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:66: void BOD_Interrupt_Enable (uint8_t u8bodINTstatus)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:68: IE &= CLR_BIT5;
	anl	_IE,#0xdf
	Sbod$BOD_Interrupt_Enable$20 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:69: IE |= (u8bodINTstatus<<5)&SET_BIT5;
	mov	dptr,#_BOD_Interrupt_Enable_u8bodINTstatus_65536_157
	movx	a,@dptr
	swap	a
	rl	a
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c:70: }
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/bod.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
...
Ldebug_line_stmt:
	...
	.db	1
	.db	9
	.dw	1+Sbod$BOD_Open$8-Sbod$BOD_Open$7
	.db	0
	.uleb128	1
	.db	1
	.db	0
	.uleb128	5
	.db	2
	.dw	0,(Sbod$BOD_LowPower$10)
	.db	3
	.sleb128	50
	.db	1
	.db	9
	.dw	Sbod$BOD_LowPower$12-Sbod$BOD_LowPower$10
	.db	3
	.sleb128	2
	.db	1
	.db	9
	.dw	Sbod$BOD_LowPower$13-Sbod$BOD_LowPower$12
	.db	3
	.sleb128	1
	.db	1
	.db	9
	...
	.db	1
	.db	9
	.dw	1+Sbod$BOD_LowPower$15-Sbod$BOD_LowPower$14
	.db	0
	.uleb128	1
	.db	1
	.db	0
	.uleb128	5
	.db	2
	.dw	0,(Sbod$BOD_Interrupt_Enable$17)
	.db	3
	.sleb128	65
	.db	1
	.db	9
	.dw	Sbod$BOD_Interrupt_Enable$19-Sbod$BOD_Interrupt_Enable$17
	.db	3
	.sleb128	2
	.db	1
	.db	9
	.dw	Sbod$BOD_Interrupt_Enable$20-Sbod$BOD_Interrupt_Enable$19
	.db	3
	.sleb128	1
	.db	1
	.db	9
	...
	.db	1
	.db	9
	.dw	1+Sbod$BOD_Interrupt_Enable$22-Sbod$BOD_Interrupt_Enable$21
	.db	0
	.uleb128	1
	.db	1
Ldebug_line_end:
...
Ldebug_loc_start:
	...
	.dw	0,(Sbod$BOD_Interrupt_Enable$23)
	.dw	2
	.db	134
	.sleb128	1
	.dw	0,0
...
Ldebug_CIE0_end:
	...
	.dw	0,(Sbod$BOD_Interrupt_Enable$18)	;initial loc
	.dw	0,Sbod$BOD_Interrupt_Enable$23-Sbod$BOD_Interrupt_Enable$18
	.db	1
	.dw	0,(Sbod$BOD_Interrupt_Enable$18)
	.db	14
	.uleb128	2
...
Ldebug_CIE1_end:
	...
	.dw	0,(Sbod$BOD_LowPower$11)	;initial loc
	.dw	0,Sbod$BOD_LowPower$16-Sbod$BOD_LowPower$11
	.db	1
	.dw	0,(Sbod$BOD_LowPower$11)
	.db	14
	.uleb128	2
...
Ldebug_CIE2_end:
	...
	.dw	0,Sbod$BOD_Open$9-Sbod$BOD_Open$1
	.db	1
	.dw	0,(Sbod$BOD_Open$1)
	.db	14
	.uleb128	2
