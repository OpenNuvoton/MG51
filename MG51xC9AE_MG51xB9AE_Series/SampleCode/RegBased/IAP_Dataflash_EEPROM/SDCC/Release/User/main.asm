...
;------------------------------------------------------------
	Smain$main$0 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:26: void main (void) 
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	Smain$main$1 ==.
	Smain$main$2 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:30: MODIFY_HIRC(HIRC_24);
	mov	dpl,#0x06
	lcall	_MODIFY_HIRC
	Smain$main$3 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:31: Enable_UART0_VCOM_printf_24M_115200();
	lcall	_Enable_UART0_VCOM_printf_24M_115200
	Smain$main$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:32: printf ("\n\r Toggle P05 to low to start... \n\r");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$5 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:34: GPIO_LED_QUASI_MODE;
	anl	_P0M1,#0xdf
	anl	_P0M2,#0xdf
	Smain$main$6 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:35: while(GPIO_LED);
00101$:
	jb	_P05,00101$
	Smain$main$7 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:38: if (Write_DATAFLASH_BYTE(0x3882,0x34)==0)
	...
	Smain$main$8 ==.
	Smain$main$9 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:40: printf ("\n\r  Dataflash R/W Byte pass \n\r");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
...
00105$:
	Smain$main$11 ==.
	Smain$main$12 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:44: printf ("\n\r write Dataflash error !!! \n\r");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
...
00106$:
	Smain$main$14 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:49: for(i=0;i<50;i++)
	mov	dptr,#_i
	clr	a
	movx	@dptr,a
	Smain$main$15 ==.
...
00117$:
	Smain$main$17 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:51: ArrayData[i]=i;
	mov	dptr,#_i
	movx	a,@dptr
	mov	r7,a
	add	a,#_ArrayData
...
00155$:
	jc	00117$
	Smain$main$19 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:53: StructData.a=0xA1A2;
	...
	movx	@dptr,a
	Smain$main$20 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:54: StructData.b=0xA3A4A5A6;
	...
	movx	@dptr,a
	Smain$main$21 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:55: StructData.c=0xA7;
	mov	dptr,#(_StructData + 0x0006)
	mov	a,#0xa7
	movx	@dptr,a
	Smain$main$22 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:57: if (Write_DATAFLASH_ARRAY(0x38E0,ArrayData,50)==0)    //write 50 bytes
	...
	Smain$main$23 ==.
	Smain$main$24 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:59: printf ("\n\r  Dataflash R/W array pass \n\r");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
...
00109$:
	Smain$main$26 ==.
	Smain$main$27 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:63: printf ("\n\r write Dataflash error !!! \n\r");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
...
00110$:
	Smain$main$29 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:66: if (Write_DATAFLASH_ARRAY(0x38FE,(uint8_t *)&StructData,sizeof(StructData))==0)//write structure
	mov	dptr,#_Write_DATAFLASH_ARRAY_PARM_2
	mov	a,#_StructData
	movx	@dptr,a
	mov	a,#(_StructData >> 8)
	...
	Smain$main$30 ==.
	Smain$main$31 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:68: printf ("\n\r  Dataflash R/W struct data pass \n\r");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
...
00112$:
	Smain$main$33 ==.
	Smain$main$34 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:72: printf ("\n\r write Dataflash  error !!! \n\r");
	mov	a,#___str_5
	push	acc
	mov	a,#(___str_5 >> 8)
	push	acc
...
00113$:
	Smain$main$36 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:85: system16highsite = ((Read_APROM_BYTE((uint16_t __code*)0x38FD)<<8)+Read_APROM_BYTE((uint16_t __code*)0x38FE));
	mov	dptr,#0x38fd
	...
	mov	r6,a
	Smain$main$37 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:88: printf ("\n\r system16highsite = 0x%X", system16highsite);
	push	ar7
	push	ar6
	mov	a,#___str_6
	push	acc
	...
	mov	sp,a
	Smain$main$38 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:90: while(1);
00115$:
	sjmp	00115$
	Smain$main$39 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c:91: }
	Smain$main$40 ==.
	XG$main$0$0 ==.
	ret
	Smain$main$41 ==.
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_Dataflash_EEPROM/main.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
