...
;------------------------------------------------------------
	Suart$UART_Open$0 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:81: void UART_Open(uint32_t u32SysClock, uint8_t u8UARTPort,uint32_t u32Baudrate)
;	-----------------------------------------
;	 function UART_Open
;	-----------------------------------------
_UART_Open:
	...
	movx	@dptr,a
	Suart$UART_Open$2 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:83: switch(u8UARTPort)
...
00121$:
	...
	Suart$UART_Open$3 ==.
	Suart$UART_Open$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:85: case UART0_Timer1:
00101$:
	Suart$UART_Open$5 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:86: SCON = 0x50;       //UART0 Mode1,REN=1,TI=1
	mov	_SCON,#0x50
	Suart$UART_Open$6 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:87: TMOD |= 0x20;      //Timer1 Mode1
	orl	_TMOD,#0x20
	Suart$UART_Open$7 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:88: set_PCON_SMOD;          //UART0 Double Rate Enable
	orl	_PCON,#0x80
	Suart$UART_Open$8 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:89: set_CKCON_T1M;
	orl	_CKCON,#0x10
	Suart$UART_Open$9 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:90: clr_T3CON_BRCK;          //Serial port 0 baud rate clock source = Timer1
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	anl	_T3CON,#0xdf
	Suart$UART_Open$10 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:91: TH1 = 256 - (u32SysClock/16/u32Baudrate);
	mov	dptr,#_UART_Open_u32SysClock_65536_153
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	_TH1,a
	Suart$UART_Open$12 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:92: set_TCON_TR1;
;	assignBit
	setb	_TR1
	Suart$UART_Open$13 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:93: break;
	ljmp	00105$
	Suart$UART_Open$14 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:95: case UART0_Timer3:
00102$:
	Suart$UART_Open$15 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:96: SCON = 0x50;     //UART0 Mode1,REN=1,TI=1
	mov	_SCON,#0x50
	Suart$UART_Open$16 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:97: set_PCON_SMOD;        //UART0 Double Rate Enable
	orl	_PCON,#0x80
	Suart$UART_Open$17 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:98: T3CON &= 0xF8;   //T3PS2=0,T3PS1=0,T3PS0=0(Prescale=1)
	anl	_T3CON,#0xf8
	Suart$UART_Open$18 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:99: set_T3CON_BRCK;        //UART0 baud rate clock source = Timer3
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	orl	_T3CON,#0x20
	Suart$UART_Open$19 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:100: RH3    = HIBYTE(65536 - (u32SysClock/16/u32Baudrate));  
	mov	dptr,#_UART_Open_u32SysClock_65536_153
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	_RH3,r1
	Suart$UART_Open$20 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:101: RL3    = LOBYTE(65536 - (u32SysClock/16/u32Baudrate));  
	clr	c
	clr	a
	subb	a,r4
	mov	r4,a
	mov	_RL3,r4
	Suart$UART_Open$21 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:102: set_T3CON_TR3;         //Trigger Timer3
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	orl	_T3CON,#0x08
	Suart$UART_Open$22 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:103: break;
	ljmp	00105$
	Suart$UART_Open$23 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:105: case UART1_Timer3:
00103$:
	Suart$UART_Open$24 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:106: SCON_1 = 0x50;     //UART1 Mode1,REN_1=1,TI_1=1
	mov	_SCON_1,#0x50
	Suart$UART_Open$25 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:107: T3CON = 0x80;     //T3PS2=0,T3PS1=0,T3PS0=0(Prescale=1), UART1 in MODE 1
	mov	_T3CON,#0x80
	Suart$UART_Open$26 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:108: RH3    = HIBYTE(65536 - (u32SysClock/16/u32Baudrate));  
	mov	dptr,#_UART_Open_u32SysClock_65536_153
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	_RH3,r1
	Suart$UART_Open$27 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:109: RL3    = LOBYTE(65536 - (u32SysClock/16/u32Baudrate));     
	clr	c
	clr	a
	subb	a,r4
	mov	r4,a
	mov	_RL3,r4
	Suart$UART_Open$28 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:110: set_T3CON_TR3;             //Trigger Timer3                                                             
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	orl	_T3CON,#0x08
	Suart$UART_Open$29 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:112: }
00105$:
	Suart$UART_Open$30 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:113: }
	Suart$UART_Open$31 ==.
	XG$UART_Open$0$0 ==.
	ret
	Suart$UART_Open$32 ==.
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:115: uint8_t Receive_Data(uint8_t UARTPort)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:119: c = 0;
	mov	dptr,#_Receive_Data_c_65536_157
	clr	a
	movx	@dptr,a
	Suart$Receive_Data$36 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:120: switch (UARTPort)
	mov	dptr,#_Receive_Data_UARTPort_65536_156
	movx	a,@dptr
	mov	r7,a
	jz	00102$
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:123: while (!RI);
	cjne	r7,#0x01,00109$
	sjmp	00106$
00102$:
	jnb	_RI,00102$
	Suart$Receive_Data$39 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:124: c = SBUF;
	mov	dptr,#_Receive_Data_c_65536_157
	mov	a,_SBUF
	movx	@dptr,a
	Suart$Receive_Data$40 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:125: RI = 0;
;	assignBit
	clr	_RI
	Suart$Receive_Data$41 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:126: break;
	Suart$Receive_Data$42 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:128: while (!RI_1);
	sjmp	00109$
00106$:
	jnb	_RI_1,00106$
	Suart$Receive_Data$43 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:129: c = SBUF_1;
	mov	dptr,#_Receive_Data_c_65536_157
	mov	a,_SBUF_1
	movx	@dptr,a
	Suart$Receive_Data$44 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:130: RI_1 = 0;
;	assignBit
	clr	_RI_1
	Suart$Receive_Data$45 ==.
	Suart$Receive_Data$46 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:132: }
00109$:
	Suart$Receive_Data$47 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:133: return (c);
	mov	dptr,#_Receive_Data_c_65536_157
	movx	a,@dptr
	Suart$Receive_Data$48 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:134: }
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:146: void UART_Send_Data(uint8_t UARTPort, uint8_t c)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:148: switch (UARTPort)
	movx	a,@dptr
	mov	r7,a
	jz	00101$
	Suart$UART_Send_Data$54 ==.
	Suart$UART_Send_Data$55 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:150: case UART0:
	cjne	r7,#0x01,00110$
	sjmp	00105$
00101$:
	Suart$UART_Send_Data$56 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:151: DISABLE_UART0_INTERRUPT;
;	assignBit
	clr	_ES
	Suart$UART_Send_Data$57 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:152: SBUF = c;
	mov	dptr,#_UART_Send_Data_PARM_2
	movx	a,@dptr
	mov	_SBUF,a
	Suart$UART_Send_Data$58 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:153: while(!TI);
00102$:
	Suart$UART_Send_Data$59 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:154: TI=0;
;	assignBit
	jbc	_TI,00138$
	sjmp	00102$
00138$:
	Suart$UART_Send_Data$60 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:155: ENABLE_UART0_INTERRUPT;
;	assignBit
	setb	_ES
	Suart$UART_Send_Data$61 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:156: break;
	Suart$UART_Send_Data$62 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:157: case UART1:
	sjmp	00110$
00105$:
	Suart$UART_Send_Data$63 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:158: DISABLE_UART1_INTERRUPT;
	anl	_EIE1,#0xfe
	Suart$UART_Send_Data$64 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:159: SBUF_1 = c;
	mov	dptr,#_UART_Send_Data_PARM_2
	movx	a,@dptr
	mov	_SBUF_1,a
	Suart$UART_Send_Data$65 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:160: while(!TI_1);
00106$:
	Suart$UART_Send_Data$66 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:161: TI_1=0;
;	assignBit
	jbc	_TI_1,00139$
	sjmp	00106$
00139$:
	Suart$UART_Send_Data$67 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:162: ENABLE_UART1_INTERRUPT;
	orl	_EIE1,#0x01
	Suart$UART_Send_Data$68 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:163: ENABLE_GLOBAL_INTERRUPT;
;	assignBit
	setb	_EA
	Suart$UART_Send_Data$69 ==.
	Suart$UART_Send_Data$70 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:165: }
00110$:
	Suart$UART_Send_Data$71 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:166: }
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:168: void Enable_UART0_VCOM_printf_24M_115200(void)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:170: P06_QUASI_MODE;
	anl	_P0M1,#0xbf
	anl	_P0M2,#0xbf
	Suart$Enable_UART0_VCOM_printf_24M_115200$77 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:171: UART_Open(24000000,UART0_Timer1,115200);
	mov	dptr,#_UART_Open_PARM_2
	clr	a
	movx	@dptr,a
	mov	dptr,#_UART_Open_PARM_3
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:172: ENABLE_UART0_PRINTF;
;	assignBit
	setb	_TI
;	assignBit
	setb	_PRINTFG
	Suart$Enable_UART0_VCOM_printf_24M_115200$79 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:173: DISABLE_UART0_INTERRUPT;
;	assignBit
	clr	_ES
	Suart$Enable_UART0_VCOM_printf_24M_115200$80 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c:174: }
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/uart.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
