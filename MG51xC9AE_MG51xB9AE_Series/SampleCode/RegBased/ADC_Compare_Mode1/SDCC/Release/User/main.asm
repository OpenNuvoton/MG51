...
;------------------------------------------------------------
	Smain$main$0 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:14: void main (void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	Smain$main$1 ==.
	Smain$main$2 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:17: MODIFY_HIRC(HIRC_24);
	mov	dpl,#0x06
	lcall	_MODIFY_HIRC
	Smain$main$3 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:18: Enable_UART0_VCOM_printf_24M_115200();
	lcall	_Enable_UART0_VCOM_printf_24M_115200
	Smain$main$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:19: printf ("\n ADC compare mode for MG51 test start... ");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$5 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:21: ENABLE_ADC_AIN4;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	orl	_ADCCON1,#0x01
	Smain$main$6 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:22: clr_ADCCON0_ADCF;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	clr	_ADCF
	Smain$main$7 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:24: ADC_ConvertTime(ADC_ADCDIV2,ADC_ADCAQT5);
	...
	Smain$main$8 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:27: ADC_ComapreMode(ENABLE,0x03FF);
	...
	Smain$main$9 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:28: clr_ADCCON0_ADCF;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	clr	_ADCF
	Smain$main$10 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:29: set_ADCCON0_ADCS; // ADC start trig signal
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	setb	_ADCS
	Smain$main$11 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:31: while(1)
00110$:
	Smain$main$12 ==.
	Smain$main$13 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:33: if (ADCF)
	jnb	_ADCF,00107$
	Smain$main$14 ==.
	Smain$main$15 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:35: printf ("\n MG51 ADC compare value same as setting");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$16 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:36: clr_ADCCON0_ADCF;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	clr	_ADCF
	Smain$main$17 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:37: set_ADCCON0_ADCS;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
00107$:
	Smain$main$19 ==.
	Smain$main$20 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:41: if (ADCCON2&SET_BIT4)
	mov	a,_ADCCON2
	jnb	acc.4,00104$
	Smain$main$21 ==.
	Smain$main$22 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:43: printf ("\n ADC value greater than comapre setting"); 
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
...
00104$:
	Smain$main$24 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:45: else if (!(ADCCON2&SET_BIT4))
	mov	a,_ADCCON2
	jb	acc.4,00108$
	Smain$main$25 ==.
	Smain$main$26 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:47: printf ("\n ADC value less than comapre setting"); 
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
...
00108$:
	Smain$main$28 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:50: Timer0_Delay(24000000,500,1000);
	...
	ljmp	00110$
	Smain$main$30 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c:53: }
	Smain$main$31 ==.
	XG$main$0$0 ==.
	ret
	Smain$main$32 ==.
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/ADC_Compare_Mode1/main.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
