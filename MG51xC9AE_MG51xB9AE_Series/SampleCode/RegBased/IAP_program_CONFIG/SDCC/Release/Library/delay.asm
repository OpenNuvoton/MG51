...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:23: void Timer0_Delay(uint32_t u32SYSCLK, uint16_t u16CNT, uint16_t u16DLYUnit)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:27: TIMER0_FSYS_DIV12;                                  //T0M=0, Timer0 Clock = Fsys/12
	anl	_CKCON,#0xf7
	Sdelay$Timer0_Delay$3 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:28: ENABLE_TIMER0_MODE1;                                   //Timer0 is 16-bit mode
	anl	_TMOD,#0xf0
	orl	_TMOD,#0x01
	Sdelay$Timer0_Delay$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:29: TL0TMP = LOBYTE(65535-((u32SYSCLK/1000000)*u16DLYUnit/12));
	mov	dptr,#_Timer0_Delay_u32SYSCLK_65536_153
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:30: TH0TMP = HIBYTE(65535-((u32SYSCLK/1000000)*u16DLYUnit/12));
	mov	a,#0xff
	clr	c
	subb	a,r4
	mov	a,#0xff
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:32: while (u16CNT != 0)
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:34: TL0=TL0TMP;
	mov	_TL0,r3
	Sdelay$Timer0_Delay$9 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:35: TH0=TH0TMP;
	mov	_TH0,r7
	Sdelay$Timer0_Delay$10 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:36: set_TCON_TR0;                                    //Start Timer0
;	assignBit
	setb	_TR0
	Sdelay$Timer0_Delay$11 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:37: while (!TF0);                       //Check Timer0 Time-Out Flag
00101$:
	Sdelay$Timer0_Delay$12 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:38: clr_TCON_TF0;
;	assignBit
	jbc	_TF0,00127$
	sjmp	00101$
00127$:
	Sdelay$Timer0_Delay$13 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:39: clr_TCON_TR0;                       //Stop Timer0
;	assignBit
	clr	_TR0
	Sdelay$Timer0_Delay$14 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:40: u16CNT --;
	dec	r5
	cjne	r5,#0xff,00128$
	dec	r6
00128$:
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:43: }
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:58: void Timer1_Delay(uint32_t u32SYSCLK, uint16_t u16CNT, uint16_t u16DLYUnit)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:62: TIMER1_FSYS_DIV12;                                 //T1M=0, Timer1 Clock = Fsys/12
	anl	_CKCON,#0xef
	Sdelay$Timer1_Delay$22 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:63: ENABLE_TIMER1_MODE1;                                //Timer1 is 16-bit mode
	anl	_TMOD,#0x0f
	orl	_TMOD,#0x10
	Sdelay$Timer1_Delay$23 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:64: TL1TMP = LOBYTE(65535-((u32SYSCLK/1000000)*u16DLYUnit)/12);
	mov	dptr,#_Timer1_Delay_u32SYSCLK_65536_156
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:65: TH1TMP = HIBYTE(65535-((u32SYSCLK/1000000)*u16DLYUnit)/12);
	mov	a,#0xff
	clr	c
	subb	a,r4
	mov	a,#0xff
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:67: while (u16CNT != 0)
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:69: TL1 = TL1TMP;
	mov	_TL1,r3
	Sdelay$Timer1_Delay$28 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:70: TH1 = TH1TMP;
	mov	_TH1,r7
	Sdelay$Timer1_Delay$29 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:71: set_TCON_TR1;                                //Start Timer1
;	assignBit
	setb	_TR1
	Sdelay$Timer1_Delay$30 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:72: while (!TF1);                                //Check Timer1 Time-Out Flag
00101$:
	Sdelay$Timer1_Delay$31 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:73: clr_TCON_TF1;
;	assignBit
	jbc	_TF1,00127$
	sjmp	00101$
00127$:
	Sdelay$Timer1_Delay$32 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:74: clr_TCON_TR1;
;	assignBit
	clr	_TR1
	Sdelay$Timer1_Delay$33 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:75: u16CNT --;
	dec	r5
	cjne	r5,#0xff,00128$
	dec	r6
00128$:
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:77: }
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:94: void Timer2_Delay(uint32_t u32SYSCLK,uint16_t u16TMDIV, uint16_t u16CNT, uint32_t u32DLYUnit)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:98: SFRS = 0x00;
	mov	_SFRS,#0x00
	Sdelay$Timer2_Delay$41 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:99: switch (u16TMDIV)
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:101: case 1:T2MOD&=0x8F; break;
	cjne	r4,#0x00,00109$
	cjne	r5,#0x02,00109$
	sjmp	00108$
00101$:
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:102: case 4:T2MOD&=0x8F;T2MOD|=0x10; break;
	sjmp	00109$
00102$:
	anl	_T2MOD,#0x8f
	orl	_T2MOD,#0x10
	Sdelay$Timer2_Delay$45 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:103: case 16:T2MOD&=0x8F;T2MOD|=0x20; break;
	sjmp	00109$
00103$:
	anl	_T2MOD,#0x8f
	orl	_T2MOD,#0x20
	Sdelay$Timer2_Delay$46 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:104: case 32:T2MOD&=0x8F;T2MOD|=0x30; break;
	sjmp	00109$
00104$:
	anl	_T2MOD,#0x8f
	orl	_T2MOD,#0x30
	Sdelay$Timer2_Delay$47 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:105: case 64:T2MOD&=0x8F;T2MOD|=0x40; break;
	sjmp	00109$
00105$:
	anl	_T2MOD,#0x8f
	orl	_T2MOD,#0x40
	Sdelay$Timer2_Delay$48 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:106: case 128:T2MOD&=0x8F;T2MOD|=0x50; break;
	sjmp	00109$
00106$:
	anl	_T2MOD,#0x8f
	orl	_T2MOD,#0x50
	Sdelay$Timer2_Delay$49 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:107: case 256:T2MOD&=0x8F;T2MOD|=0x60; break;
	sjmp	00109$
00107$:
	anl	_T2MOD,#0x8f
	orl	_T2MOD,#0x60
	Sdelay$Timer2_Delay$50 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:108: case 512:T2MOD&=0x8F;T2MOD|=0x70; break;
	sjmp	00109$
00108$:
	anl	_T2MOD,#0x8f
	orl	_T2MOD,#0x70
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:109: }
00109$:
	Sdelay$Timer2_Delay$53 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:110: clr_T2CON_CMRL2;                                  //Timer 2 as auto-reload mode
;	assignBit
	clr	_CM_RL2
	Sdelay$Timer2_Delay$54 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:111: set_T2MOD_LDEN;
	orl	_T2MOD,#0x80
	Sdelay$Timer2_Delay$55 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:112: set_T2MOD_CMPCR;                                  //Timer 2 value is auto-cleared as 0000H when a compare match occurs.
	orl	_T2MOD,#0x04
	Sdelay$Timer2_Delay$56 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:113: TL2TMP = LOBYTE(65536-((u32SYSCLK/1000000)*u32DLYUnit/u16TMDIV));
	mov	dptr,#_Timer2_Delay_u32SYSCLK_65536_159
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:114: TH2TMP = HIBYTE(65536-((u32SYSCLK/1000000)*u32DLYUnit/u16TMDIV));
	clr	a
	clr	c
	subb	a,r4
	clr	a
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:115: while (u16CNT != 0)
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:117: TL2 = TL2TMP;
	mov	_TL2,r3
	Sdelay$Timer2_Delay$61 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:118: TH2 = TH2TMP;
	mov	_TH2,r7
	Sdelay$Timer2_Delay$62 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:119: set_T2CON_TR2;                                    //Start Timer2
;	assignBit
	setb	_TR2
	Sdelay$Timer2_Delay$63 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:120: while (TF2!=1);            //Check Timer2 Time-Out Flag
00110$:
	Sdelay$Timer2_Delay$64 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:121: clr_T2CON_TF2;
;	assignBit
	jbc	_TF2,00176$
	sjmp	00110$
00176$:
	Sdelay$Timer2_Delay$65 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:122: clr_T2CON_TR2;                                    //Stop Timer2
;	assignBit
	clr	_TR2
	Sdelay$Timer2_Delay$66 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:123: u16CNT --;
	dec	r5
	cjne	r5,#0xff,00177$
	dec	r6
00177$:
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:125: }
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:141: void Timer3_Delay(uint32_t u32SYSCLK,uint8_t u8TMDIV, uint16_t u16CNT, uint32_t u32DLYUnit)
;	-----------------------------------------
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:145: SFRS = 0x00;
	mov	_SFRS,#0x00
	Sdelay$Timer3_Delay$74 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:146: switch (u8TMDIV)
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:148: case 1:T3CON&=0xF8; break;
	cjne	r7,#0x80,00109$
	sjmp	00108$
00101$:
	anl	_T3CON,#0xf8
	Sdelay$Timer3_Delay$77 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:149: case 2:T3CON&=0xF8;T3CON|=0x01; break;
	sjmp	00109$
00102$:
	anl	_T3CON,#0xf8
	orl	_T3CON,#0x01
	Sdelay$Timer3_Delay$78 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:150: case 4:T3CON&=0xF8;T3CON|=0x02; break;
	sjmp	00109$
00103$:
	anl	_T3CON,#0xf8
	orl	_T3CON,#0x02
	Sdelay$Timer3_Delay$79 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:151: case 8:T3CON&=0xF8;T3CON|=0x03; break;
	sjmp	00109$
00104$:
	anl	_T3CON,#0xf8
	orl	_T3CON,#0x03
	Sdelay$Timer3_Delay$80 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:152: case 16:T3CON&=0xF8;T3CON|=0x04; break;
	sjmp	00109$
00105$:
	anl	_T3CON,#0xf8
	orl	_T3CON,#0x04
	Sdelay$Timer3_Delay$81 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:153: case 32:T3CON&=0xF8;T3CON|=0x05; break;
	sjmp	00109$
00106$:
	anl	_T3CON,#0xf8
	orl	_T3CON,#0x05
	Sdelay$Timer3_Delay$82 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:154: case 64:T3CON&=0xF8;T3CON|=0x06; break;
	sjmp	00109$
00107$:
	anl	_T3CON,#0xf8
	orl	_T3CON,#0x06
	Sdelay$Timer3_Delay$83 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:155: case 128:T3CON&=0xF8;T3CON|=0x07; break;
	sjmp	00109$
00108$:
	anl	_T3CON,#0xf8
	orl	_T3CON,#0x07
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:156: }
00109$:
	Sdelay$Timer3_Delay$86 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:157: TL3TMP = LOBYTE(65536-((u32SYSCLK/1000000)*u32DLYUnit/u8TMDIV));
	mov	dptr,#_Timer3_Delay_u32SYSCLK_65536_163
	movx	a,@dptr
	mov	r3,a
	inc	dptr
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:158: TH3TMP = HIBYTE(65536-((u32SYSCLK/1000000)*u32DLYUnit/u8TMDIV));
	clr	a
	clr	c
	subb	a,r4
	clr	a
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:160: while (u16CNT != 0)
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:162: clr_T3CON_TF3;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:163: RL3 = TL3TMP;
	mov	_RL3,r3
	Sdelay$Timer3_Delay$92 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:164: RH3 = TH3TMP;
	mov	_RH3,r7
	Sdelay$Timer3_Delay$93 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:165: set_T3CON_TR3;                                    //Trigger Timer3
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:166: while (!(T3CON&SET_BIT4));                        //Check Timer3 Time-Out Flag
00110$:
	mov	a,_T3CON
	jnb	acc.4,00110$
	Sdelay$Timer3_Delay$95 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:167: clr_T3CON_TF3;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:168: clr_T3CON_TR3;                                    //Stop Timer3
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:169: u16CNT --;
	dec	r5
	cjne	r5,#0xff,00177$
	dec	r6
00177$:
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:171: clr_T3CON_TR3;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c:172: }
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/Library/StdDriver/src/delay.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
