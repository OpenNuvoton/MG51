...
;------------------------------------------------------------
	Smain$main$0 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:14: void main (void) 
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	Smain$main$1 ==.
	Smain$main$2 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:18: MODIFY_HIRC(HIRC_24);
	mov	dpl,#0x06
	lcall	_MODIFY_HIRC
	Smain$main$3 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:19: Enable_UART0_VCOM_printf_24M_115200();
	lcall	_Enable_UART0_VCOM_printf_24M_115200
	Smain$main$4 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:20: printf ("\n\r MCU Reset.   ");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$5 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:21: printf ("\n\r Toggle P0.5 to low to start test... \n\r ");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$6 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:25: Read_CONFIG();
	lcall	_Read_CONFIG
	Smain$main$7 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:26: printf ("\n\r Now config value is :   ");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
	...
	Smain$main$8 ==.
	Smain$main$9 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:27: for(ct=0;ct<5;ct++)
	Smain$main$10 ==.
	mov	r7,#0x00
00111$:
	Smain$main$11 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:34: printf ("\r 0x%bX", IAPCFBuf[ct]);
	mov	a,r7
	add	a,#_IAPCFBuf
	mov	dpl,a
	clr	a
...
00140$:
	jc	00111$
	Smain$main$13 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:37: printf ("\n\r ");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$14 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:40: GPIO_LED_QUASI_MODE;
	anl	_P0M1,#0xdf
	anl	_P0M2,#0xdf
	Smain$main$15 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:41: while(GPIO_LED);
00102$:
	jb	_P05,00102$
	Smain$main$16 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:42: Timer0_Delay(24000000,200,1000);
	...
	lcall	_Timer0_Delay
	Smain$main$17 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:43: Modify_CONFIG(0xEF,0xFB,0x6B,0xFF,0xFF);
	...
	Smain$main$18 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:45: SFRS=0;
	mov	_SFRS,#0x00
	Smain$main$19 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:46: if(ConfigModifyFlag)        /* Check with power on flag. Only the first power on check with CONFIG */
	jnb	_ConfigModifyFlag,00106$
	Smain$main$20 ==.
	Smain$main$21 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:48: SFRS=0;printf ("\n\r CONFIG MODIFY to 0xEF,0xFB,0x6B,0xFF,0xFF !!!");
	mov	_SFRS,#0x00
	mov	a,#___str_5
	push	acc
	mov	a,#(___str_5 >> 8)
	...
	dec	sp
	Smain$main$22 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:49: printf ("\n\r Reset MCU to take effect...  \n\r ");
	mov	a,#___str_6
	push	acc
	mov	a,#(___str_6 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$23 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:50: ConfigModifyFlag=0;
;	assignBit
	clr	_ConfigModifyFlag
	Smain$main$24 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:51: Software_Reset(BOOT_APROM);    // IMPORTANT !! only after reset the modify  take effect
	mov	dpl,#0x00
...
00106$:
	Smain$main$26 ==.
	Smain$main$27 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:55: SFRS=0;
	mov	_SFRS,#0x00
	Smain$main$28 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:56: printf ("\n\r CONFIG same as last time modify value ... not Modify again");
	mov	a,#___str_7
	push	acc
	mov	a,#(___str_7 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$29 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:57: printf ("\n\r or Modify_CONFIG API Only allowed ONCE after Power ON reset");
	mov	a,#___str_8
	push	acc
	mov	a,#(___str_8 >> 8)
	push	acc
	...
	Smain$main$30 ==.
	Smain$main$31 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:60: while(1);
00109$:
	sjmp	00109$
	Smain$main$32 ==.
;	C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c:61: }
	Smain$main$33 ==.
	XG$main$0$0 ==.
	ret
	Smain$main$34 ==.
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51xC9AE_MG51xB9AE_Series/SampleCode/RegBased/IAP_program_CONFIG/main.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
