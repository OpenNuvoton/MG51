  ...
  switch (u8PullMode)
  {
    case PULLUP:
        switch(u8Port)
        {
		  ...
		  case Port5:  SFRS=1;P5UP |= u8PinMask;  break;		  
        }
    break;
    case PULLDOWN:
        switch(u8Port)
        {
		  ...
		  case Port5:  SFRS=1;P5DW |= u8PinMask;  break;
        }
    break;
    }
}
...
void GPIO_SetMode(uint8_t u8Port, uint8_t u8PinMask, uint8_t u8Mode)
{
    ...
    switch(u8Port)
    {
		...
		case Port4:  SFRS=1; u8PnM1 = P4M1;  u8PnM2 = P4M2;  break;
		case Port5:  SFRS=1; u8PnM1 = P5M1;  u8PnM2 = P5M2;  break;
    }
    switch(u8Mode)
    {
    ...
    switch(u8Port)
    {
		...
		case Port4:  SFRS=1; P4M1 = u8PnM1;  P4M2 = u8PnM2;  break;
		case Port5:  SFRS=1; P5M1 = u8PnM1;  P5M2 = u8PnM2;  break;
    }
}
