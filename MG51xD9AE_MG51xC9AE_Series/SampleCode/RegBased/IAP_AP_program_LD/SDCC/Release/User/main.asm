...
;------------------------------------------------------------
	Smain$main$0 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:16: void main (void) 
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	Smain$main$1 ==.
	Smain$main$2 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:20: MODIFY_HIRC(HIRC_24);
	mov	dpl,#0x06
	lcall	_MODIFY_HIRC
	Smain$main$3 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:21: Enable_UART0_VCOM_printf_24M_115200();
	lcall	_Enable_UART0_VCOM_printf_24M_115200
	Smain$main$4 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:23: printf ("\n CONFIG enable LDROM area first ...");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$5 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:24: printf ("\n Toggle P05 to low to start test ...");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$6 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:26: for (i=0;i<128;i++)
	mov	r7,#0x00
00108$:
	Smain$main$7 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:27: IAPDataBuf[i]=i;
	mov	a,r7
	add	a,#_IAPDataBuf
	mov	dpl,a
	clr	a
...
00133$:
	jc	00108$
	Smain$main$9 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:29: GPIO_LED_QUASI_MODE;
	anl	_P0M1,#0xdf
	anl	_P0M2,#0xdf
	Smain$main$10 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:30: while(GPIO_LED);
00102$:
	jb	_P05,00102$
	Smain$main$11 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:32: Erase_LDROM(DATA_START_ADDR,128);
	...
	lcall	_Erase_LDROM
	Smain$main$12 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:33: Erase_Verify_LDROM(DATA_START_ADDR,128);
	...
	movx	@dptr,a
	mov	dptr,#0x0000
	lcall	_Erase_Verify_LDROM
	Smain$main$13 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:34: Program_LDROM(DATA_START_ADDR,128);
	...
	movx	@dptr,a
	mov	dptr,#0x0000
	lcall	_Program_LDROM
	Smain$main$14 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:35: Program_Verify_LDROM(DATA_START_ADDR,128);
	...
	movx	@dptr,a
	mov	dptr,#0x0000
	lcall	_Program_Verify_LDROM
	Smain$main$15 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:37: while(1);
00106$:
	sjmp	00106$
	Smain$main$16 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c:38: }
	Smain$main$17 ==.
	XG$main$0$0 ==.
	ret
	Smain$main$18 ==.
...
___str_0:
	.db 0x0a
	.ascii " CONFIG enable LDROM area first ..."
	.db 0x00
	.area CSEG    (CODE)
Fmain$__str_1$0_0$0 == .
	.area CONST   (CODE)
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/IAP_AP_program_LD/main.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
