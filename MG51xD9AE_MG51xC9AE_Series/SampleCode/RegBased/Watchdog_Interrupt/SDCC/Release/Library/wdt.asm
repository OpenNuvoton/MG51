...
;------------------------------------------------------------
	Swdt$WDT_Open$0 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:32: void WDT_Open(uint16_t u8WDTDIV)
;	-----------------------------------------
;	 function WDT_Open
;	-----------------------------------------
_WDT_Open:
	...
	movx	@dptr,a
	Swdt$WDT_Open$2 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:34: SFRS=0;
	mov	_SFRS,#0x00
	Swdt$WDT_Open$3 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:35: BIT_TMP=EA;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
	Swdt$WDT_Open$4 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:36: EA=0;
;	assignBit
	clr	_EA
	Swdt$WDT_Open$5 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:37: switch (u8WDTDIV)
	mov	dptr,#_WDT_Open_u8WDTDIV_65536_153
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00152$:
	...
	Swdt$WDT_Open$6 ==.
	Swdt$WDT_Open$7 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:39: case 1: TA=0xAA;TA=0x55;WDCON&=0xF8; break;
00101$:
	mov	_TA,#0xaa
	mov	_TA,#0x55
	anl	_WDCON,#0xf8
	ljmp	00110$
	Swdt$WDT_Open$8 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:40: case 4: TA=0xAA;TA=0x55;WDCON&=0xF8;TA=0xAA;TA=0x55;WDCON|=0x01; break;
00102$:
	mov	_TA,#0xaa
	mov	_TA,#0x55
	anl	_WDCON,#0xf8
	...
	orl	_WDCON,#0x01
	Swdt$WDT_Open$9 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:41: case 8: TA=0xAA;TA=0x55;WDCON&=0xF8;TA=0xAA;TA=0x55;WDCON|=0x02; break;
	sjmp	00110$
00103$:
	mov	_TA,#0xaa
	mov	_TA,#0x55
	...
	orl	_WDCON,#0x02
	Swdt$WDT_Open$10 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:42: case 16: TA=0xAA;TA=0x55;WDCON&=0xF8;TA=0xAA;TA=0x55;WDCON|=0x03; break;
	sjmp	00110$
00104$:
	mov	_TA,#0xaa
	mov	_TA,#0x55
	...
	orl	_WDCON,#0x03
	Swdt$WDT_Open$11 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:43: case 32: TA=0xAA;TA=0x55;WDCON&=0xF8;TA=0xAA;TA=0x55;WDCON|=0x04; break;
	sjmp	00110$
00105$:
	mov	_TA,#0xaa
	mov	_TA,#0x55
	...
	orl	_WDCON,#0x04
	Swdt$WDT_Open$12 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:44: case 64: TA=0xAA;TA=0x55;WDCON&=0xF8;TA=0xAA;TA=0x55;WDCON|=0x05; break;
	sjmp	00110$
00106$:
	mov	_TA,#0xaa
	mov	_TA,#0x55
	...
	orl	_WDCON,#0x05
	Swdt$WDT_Open$13 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:45: case 128: TA=0xAA;TA=0x55;WDCON&=0xF8;TA=0xAA;TA=0x55;WDCON|=0x06; break;
	sjmp	00110$
00107$:
	mov	_TA,#0xaa
	mov	_TA,#0x55
	...
	orl	_WDCON,#0x06
	Swdt$WDT_Open$14 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:46: case 256: TA=0xAA;TA=0x55;WDCON&=0xF8;TA=0xAA;TA=0x55;WDCON|=0x07; break;
	sjmp	00110$
00108$:
	mov	_TA,#0xaa
	mov	_TA,#0x55
	...
	Swdt$WDT_Open$15 ==.
	Swdt$WDT_Open$16 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:48: }
00110$:
	Swdt$WDT_Open$17 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:49: EA = BIT_TMP;
;	assignBit
	mov	c,_BIT_TMP
	mov	_EA,c
	Swdt$WDT_Open$18 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:50: set_WDCON_WIDPD;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	mov	_EA,c
	Swdt$WDT_Open$19 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:51: set_WDCON_WDTR;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	mov	_EA,c
	Swdt$WDT_Open$20 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:52: }
	Swdt$WDT_Open$21 ==.
	XG$WDT_Open$0$0 ==.
	ret
	Swdt$WDT_Open$22 ==.
...
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:62: void WDT_Interrupt(uint8_t u8WDTINT)
;	-----------------------------------------
...
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:64: switch (u8WDTINT)
	movx	a,@dptr
	mov	r7,a
	jz	00101$
	Swdt$WDT_Interrupt$26 ==.
	Swdt$WDT_Interrupt$27 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:66: case Disable: clr_EIE_EWDT; break;    
	cjne	r7,#0x01,00104$
	sjmp	00102$
00101$:
	anl	_EIE,#0xef
	Swdt$WDT_Interrupt$28 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:67: case Enable: set_EIE_EWDT; break;
	sjmp	00104$
00102$:
	orl	_EIE,#0x10
	Swdt$WDT_Interrupt$29 ==.
	Swdt$WDT_Interrupt$30 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:68: }
00104$:
	Swdt$WDT_Interrupt$31 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:69: }
...
;------------------------------------------------------------
	Swdt$WDT_Clear$34 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:79: void WDT_Clear(void)
;	-----------------------------------------
;	 function WDT_Clear
;	-----------------------------------------
_WDT_Clear:
	Swdt$WDT_Clear$35 ==.
	Swdt$WDT_Clear$36 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:81: WDT_COUNTER_CLEAR;                  /* Clear WDT counter */ 
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	mov	_EA,c
	Swdt$WDT_Clear$37 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:82: while(WDCON&SET_BIT6);              /* Check for the WDT counter cleared */
00101$:
	mov	a,_WDCON
	jb	acc.6,00101$
	Swdt$WDT_Clear$38 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c:83: }
	Swdt$WDT_Clear$39 ==.
	XG$WDT_Clear$0$0 ==.
	ret
	Swdt$WDT_Clear$40 ==.
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/Library/StdDriver/src/wdt.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
