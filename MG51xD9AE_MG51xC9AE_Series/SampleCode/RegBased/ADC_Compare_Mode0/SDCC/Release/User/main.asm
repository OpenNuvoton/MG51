...
;------------------------------------------------------------
	Smain$main$0 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:14: void main (void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	Smain$main$1 ==.
	Smain$main$2 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:17: MODIFY_HIRC(HIRC_166);
	mov	dpl,#0x08
	lcall	_MODIFY_HIRC
	Smain$main$3 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:18: P06_QUASI_MODE;
	anl	_P0M1,#0xbf
	anl	_P0M2,#0xbf
	Smain$main$4 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:19: UART_Open(16600000,UART0_Timer1,115200);
	...
	lcall	_UART_Open
	Smain$main$5 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:20: ENABLE_UART0_PRINTF;
;	assignBit
	setb	_TI
;	assignBit
	setb	_PRINTFG
	Smain$main$6 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:21: printf ("\n ADC compare mode for N76S003 test start... ");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	Smain$main$7 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:24: ENABLE_ADC_AIN4;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	orl	_ADCCON1,#0x01
	Smain$main$8 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:27: ADC_ComapreMode(ENABLE,0x3FF);
	...
	Smain$main$9 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:28: clr_ADCCON0_ADCF;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	clr	_ADCF
	Smain$main$10 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:29: set_ADCCON0_ADCS; // ADC start trig signal
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	Smain$main$11 ==.
	Smain$main$12 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:33: while (!ADCF);
00101$:
	jnb	_ADCF,00101$
	Smain$main$13 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:34: if (ADCCON2&SET_BIT4)
	mov	a,_ADCCON2
	jnb	acc.4,00107$
	Smain$main$14 ==.
	Smain$main$15 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:36: printf ("\n ADC value greater than comapre setting"); 
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
...
00107$:
	Smain$main$17 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:38: else if (!(ADCCON2&SET_BIT4))
	mov	a,_ADCCON2
	jb	acc.4,00108$
	Smain$main$18 ==.
	Smain$main$19 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:40: printf ("\n ADC value less than comapre setting"); 
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
...
00108$:
	Smain$main$21 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:42: Timer0_Delay(24000000,500,1000);
	...
	lcall	_Timer0_Delay
	Smain$main$22 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:43: clr_ADCCON0_ADCF;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	clr	_ADCF
	Smain$main$23 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:44: set_ADCCON0_ADCS;
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
;	assignBit
...
;	assignBit
	...
	ljmp	00101$
	Smain$main$25 ==.
;	C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c:46: }
	Smain$main$26 ==.
	XG$main$0$0 ==.
	ret
	Smain$main$27 ==.
...
Ldebug_line_start:
	...
	.db	0
	.db	0
	.ascii "C:/BSP/MG51_Series_V1.02.000_pychecked/MG51xB9AE_MG51xC9AE_Series/SampleCode/RegBased/ADC_Compare_Mode0/main.c"
	.db	0
	.uleb128	0
	.uleb128	0
	.uleb128	0
